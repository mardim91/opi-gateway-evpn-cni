...
// package main holds the main functionality of opi-gateway-evpn-cni
package main
...
import (
	...
	"github.com/opiproject/opi-gateway-evpn-cni/pkg/config"
	"github.com/opiproject/opi-gateway-evpn-cni/pkg/sriov"
	evpngwtypes "github.com/opiproject/opi-gateway-evpn-cni/pkg/types"
	"github.com/opiproject/opi-gateway-evpn-cni/pkg/utils"
	"github.com/opiproject/opi-gateway-evpn-cni/pkg/xpu"
	...
	if !netConf.DPDKMode {
		if args.Netns == "" {
			...
			if err != nil {
				...
				err = sm.ReleaseVF(args.ContainerID, netConf, netns, args.Netns)
				if err != nil {
